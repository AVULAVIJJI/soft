...
export default function ForgotPassword() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      const r = await fetch(`${API}/api/v1/auth/forgot-password`, { method:"POST", headers:{"Content-Type":"application/json"}, body:JSON.stringify({email, portal:"academy"}) });
  ...
  return (
    <div style={S.wrap}><div style={S.card}>
      ...
      <div style={S.sub as React.CSSProperties}>ACADEMY PORTAL</div>
      {sent ? (
